...
const ticketsInput = new SpreadsheetIOAdapter(
  TRACKING_SHEET_NAME,
  TRACKING_TICKET_RANGE
);
const estimatedTimesInput = new SpreadsheetIOAdapter(
  TRACKING_SHEET_NAME,
  TRACKING_ESTIMATED_TIME_RANGE
);
const daysInput = new SpreadsheetIOAdapter(
  TRACKING_SHEET_NAME,
  TRACKING_DAY_RANGE
);
const startTimesInput = new SpreadsheetIOAdapter(
  TRACKING_SHEET_NAME,
  TRACKING_START_TIME_RANGE
);
const endTimesInput = new SpreadsheetIOAdapter(
  TRACKING_SHEET_NAME,
  TRACKING_END_TIME_RANGE
);
const summaryOutput = new SpreadsheetIOAdapter(
  TRACKING_SHEET_NAME,
  TRACKING_SUMMARY_OUTPUT_RANGE
);
const distributedOutput = new SpreadsheetIOAdapter(
  TRACKING_SHEET_NAME,
